...
# Parsing + Configuration Script – Shelly Pro 3EM - 120A - Rev. A

This **Parsing + Configuration** script is designed for the **Shelly Pro 3EM - 120A** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Shelly Pro 3EM - 120A Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Shelly Pro 3EM - 120A** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
